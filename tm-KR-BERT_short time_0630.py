...
df_topics.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/df_topics_words0702.csv', index=False, encoding='cp949')


# CSV 파일 불러오기
df_topics = pd.read_csv('D:/대학원/논문/소논문/부동산_토픽모델링/df_topics_words0702.csv', encoding='cp949')
...
topics_over_time.to_csv('D:/대학원/논문/소논문/부동산_토픽모델링/topics_over_time0702.csv', index=False, encoding='utf-8')

topics_over_time = pd.read_csv('D:/대학원/논문/소논문/부동산_토픽모델링/topics_over_time0702.csv', encoding='utf-8')
