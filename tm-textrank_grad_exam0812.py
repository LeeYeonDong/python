...
#### 6.1 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting + Glove
...
#### 7.1 textrank + term frequency, term postion, word co-occurence + Infomap + Glove
...
#### 8.1 textrank + term frequency, term postion, word co-occurence + Infomap + Glove + Hierarchical
...
#### 9.1 textrank + term frequency, term postion, word co-occurence + Infomap + Multi Entropy + Glove
